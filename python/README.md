...
Names stored in the archive must be ASCII. Local source and output paths may
contain Unicode. Empty files are not valid cozip entries; the writer rejects
them before replacing the output.
